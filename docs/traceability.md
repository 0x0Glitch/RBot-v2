...
| 11.9–11.17 | Frozen-direction rate episodes with non-rearming cumulative budgets and durable recovery | `src/planner/episodes.rs`, `src/storage/actor.rs` | budget, uniqueness, reopen and reorg-reversal tests | Implemented for release-one episode states |
